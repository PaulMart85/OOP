...
public abstract class BaseHero implements ActionsInterface {
    ...
    protected int health; // нужен еще текущее здоровье.
    protected int speed;
    protected boolean status;
    protected String state; // стоит идет ударил того-то вылечил того-то
    ...
    public String indicateState() {
        return name + " H:" + health + " D:" + defence + " A:" + attack + " " + state;
    }
